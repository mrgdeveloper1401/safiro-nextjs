// app/(auth)/verify-otp-phone

// app/(auth)/verify-forget-password/page.tsx
import { VerifyOtpPhone } from "@/components/auth/verify-otp-phone/VerifyOtpPhone";
...
const verifyOtpPhone = async () => {
  ...
  if (!phone) {
    return redirect("/request-otp-phone");
  }

  return <VerifyOtpPhone />;
};
