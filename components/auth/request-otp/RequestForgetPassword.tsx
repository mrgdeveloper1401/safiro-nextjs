    ...
    try {
      ...
      if (isAxiosError(error)) {
        ...
        if (status === 404) {
          ...
          forgetForm.setError("root", { message: "خطای سرور" });
        } else {
          forgetForm.setError("root", {
        ...
        forgetForm.setError("root", { message: "خطای ناشناخته" });
      }
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 backdrop-blur-sm z-50 flex items-center justify-center">
      <div className="bg-linear-to-br from-white to-gray-50 rounded-2xl shadow-2xl w-full max-w-md mx-4 relative">
        ...
        <div className="p-6">
          <form onSubmit={forgetForm.handleSubmit(onSubmit)} className="space-y-4">
            {/* شماره موبایل */}
            <div>
